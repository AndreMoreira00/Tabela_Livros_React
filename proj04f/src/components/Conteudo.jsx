...
export function Musica(props){
    return <ModeloConteudo>
      <ConteudoCapa src={ props.imagem } alt="capa da musica"/>
      <ConteudoTitulo>{ props.nome }</ConteudoTitulo>
      <ConteudoInfo> { props.compositor }</ConteudoInfo>
      <ConteudoInfo> { props.lancamento }</ConteudoInfo>
    </ModeloConteudo>  
  }
